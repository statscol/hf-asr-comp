...
def main():
    ...
    with training_args.main_process_first(desc="dataset map clean batch removal"):
        raw_datasets = raw_datasets.map(
            clean_batch,
            remove_columns=[text_column_name],
            desc="remove rare characters from datasets",
        )
    ...
    with training_args.main_process_first(desc="dataset map homologate batch removal"):
        raw_datasets = raw_datasets.map(
            homologate_accents,
            remove_columns=[text_column_name],
            desc="homologate accents characters from datasets",
        )
